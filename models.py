...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        #return f"A NearEarthObject {self.designation!r} ({self.name!r}) has a diameter of {self.diameter:.3f} km & is potentially {haz}"
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # method for examples of advanced string formatting.
        #{self.neo.fullname}
        return f"On {self.time_str!r},  {self.neo.fullname} approaches at a distance of {self.distance:.2f} & a velocity of {self.velocity:.2f}"
